...
内置模板：**`gda_reverse_1999`（暴雨观测档案 Reverse: 1999）**。这是一个以《重返未来：1999》为灵感的基金会时序观测报告：维尔汀主持首屏与活跃图，话题被归档为时代回声，群友进入神秘学观测站，金句成为时间回响，十四行诗负责最终结案。整页以旧档案纸、暴雨蓝灰、酒红警示和黄铜编号组织连续阅读，而不是普通的数据卡片堆叠。
...
模板重做为“基金会暴雨档案”风格：米白纸张作为主底色，蓝灰承担时间与数据，酒红标记重点和峰值，黄铜用于档案编号与印章。官网角色素材作为叙事锚点，首屏使用维尔汀，结案使用十四行诗；远程渲染直接读取官网绝对 URL。
...
- 暴雨首屏：维尔汀与官网场景背板构成基金会报告封面。
- 暴雨前线：24 小时活跃柱状图以峰值标记群聊节奏。
- 时代回声：话题以编号记录和证据详情沿时间顺序归档。
- 神秘学观测站：群友头像、称号与理由组成成员档案。
- 时间回响与司辰结案：金句保存为语句残响，十四行诗完成最终观测。
...
- 首屏暴雨场景：`https://re.bluepoch.com/home/img/first/1.png`
- 维尔汀主视觉：`https://re.bluepoch.com/home/img/role/2.png`
- 十四行诗观测结论：`https://re.bluepoch.com/home/img/role/3.png`
- 官网角色缩略图候选：`https://re.bluepoch.com/home/img/character/1.png` 至 `10.png`
